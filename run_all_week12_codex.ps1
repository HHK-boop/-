...
try {
    ...
    & $Python code\week12_expansion_pipeline.py
    powershell.exe -NoProfile -ExecutionPolicy Bypass -File database\run_postgres_temp_week12.ps1
    & $Python code\week12_expansion_pipeline.py
    & $Node code\build_week12_workbook.mjs
    & $Python code\build_week12_report_pdf.py
}
finally {
    Pop-Location
}
